...
function Footer() {
  return (
      ...
      <footer className="border-t border-gray-200 p-4">
        <div className="container mx-auto flex  justify-between py-4 gap-10">
          <div>
            <Image src="/logo.png" alt="Logo" width={100} height={100} />
          </div>

          <nav className="text-sm border-l-3 border-gray-100 pl-8">
            <p className="text-red-600 mb-4 font-semibold">Menu</p>
          ...
          <div className="text-sm border-l-3 border-gray-100 pl-8">
